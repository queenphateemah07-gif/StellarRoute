...
import { DEFAULT_LOCALE, getUserLocale, Locale } from '@/lib/formatting';
...
const SWAP_TRANSLATIONS: Record<SupportedSwapLocale, SwapTranslations> = {
  'en-US': {
    ...
    'swap.fees.routerFee.description': 'Fee for using StellarRoute aggregator',
    'swap.fees.poolFee.name': 'Pool Fee',
    'swap.fees.poolFee.description': 'Liquidity provider fee for AQUA pool',
    'swap.fees.baseFee.name': 'Base Fee',
    'swap.fees.baseFee.description': 'Stellar network base transaction fee',
    'swap.fees.operationFee.name': 'Operation Fee',
    'swap.fees.operationFee.description': 'Fee for path payment operations',
    ...
    'settings.notifications.enabledAria':
      'Browser notifications: enabled. Click to disable.',
    'settings.notifications.disabledAria':
    ...
    'settings.slippage.lowWarning':
      'Your transaction may fail if the price moves unfavorably by more than {value}%.',
    'settings.slippage.highWarning':
    ...
    'swap.confirm.submitted.description':
      'Transaction submitted, awaiting confirmation on the network.',
    'swap.confirm.submitted.announcement':
      'Transaction submitted, awaiting confirmation.',
    'swap.confirm.confirmed.heading': 'Swap confirmed',
    'swap.confirm.confirmed.description':
      'Your swap has been confirmed on the Stellar network.',
  ...
  'es-ES': {
    ...
    'swap.card.offlineQuoteError':
      'Estás desconectado. Reconéctate para actualizar la cotización.',
    ...
    'swap.simulation.emptyState':
      'Introduce una cantidad para ver la simulación',
    ...
    'swap.card.diagnostics': 'View quote diagnostics',
    'swap.card.outdated':
      'Cotización desactualizada — actualiza para obtener el precio más reciente',
    'swap.card.recoveringQuote': 'Reintentando cotización...',
    'swap.card.recoveringQuoteCountdown':
      'Reintentando cotización en {seconds}s...',
    ...
    'orderbook.row.bid.aria':
      'Precio de oferta {price}, cantidad {amount}, total {total}',
    'orderbook.row.ask.aria':
      'Precio de demanda {price}, cantidad {amount}, total {total}',
    'orderbook.depth.title': 'Profundidad del mercado',
    'orderbook.depth.modeLabel': 'Modo',
    'orderbook.depth.mode.compact': 'Compacto (Lienzo)',
    ...
    'orderbook.depth.uiJitter': 'Límite de fluctuación de UI',
    'orderbook.depth.activeStrategy': 'Estrategia activa',
    'orderbook.depth.strategy.canvas': 'Bucle de lienzo adaptativo',
  ...
  'zh-CN': {
    ...
    'settings.slippage.lowWarning':
      '如果价格对您不利的波动超过 {value}%，您的交易可能会失败。',
    'settings.slippage.highWarning':
      '高滑点会增加被抢先交易和获得明显更差价格的风险。',
    'settings.locale.title': '语言和地区',
    'settings.locale.description':
      '选择你的首选语言和数字格式。这会影响金额、价格和其他数字的显示方式。',
    'settings.locale.example': '示例：{amount} · {percent}',
    'settings.expert.mode': '专家模式',
    'settings.expert.warning':
      '专家模式允许高度自定义的数值和功能。请注意：较高的滑点限制可能会导致糟糕的执行价格或遭遇抢先交易。',
    'settings.expert.bypass': '绕过确认弹窗',
    'settings.expert.bypassDescription':
      '单击即可立即执行交易。适用于瞬息万变的市场。',
    'settings.expert.diagnostics': '扩展路径诊断',
    'settings.expert.diagnosticsDescription':
      '显示原始流动性池、池储备量和精确的多跳路径指标。',
    ...
    'orderbook.depth.fps': '{fps} FPS',
    'orderbook.depth.maxVolume': '最大交易量: {volume} 单位',
    'orderbook.depth.renderCost': '渲染开销',
    'orderbook.depth.memoryProfiler': '内存分析',
    'orderbook.depth.uiJitter': 'UI 抖动界限',
...
export function createSwapTranslator(locale?: Locale | null) {
  ...
  return {
    ...
    t: (key: SwapTranslationKey, variables?: Record<string, string | number>) =>
